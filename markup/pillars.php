...
<section class="pillar-section additional-content">
    <div class="main-wrapper">
        ...
        <div class="inner-wrapper">
            <h2><?php echo $pillar1Headline;?></h2>
            <p><?php echo $pillar1Text;?></p>
        </div>
    </div>
</section>
<section class="pillar-section section-dark additional-content">
    <div class="main-wrapper">
        ...
        <div class="inner-wrapper">
            <h2><?php echo $pillar2Headline;?></h2>
            <p><?php echo $pillar2Text;?></p>
        </div>
    </div>
</section>
<section class="pillar-section additional-content">
    <div class="main-wrapper">
        ...
        <div class="inner-wrapper">
            <h2><?php echo $pillar3Headline;?></h2>
            <p><?php echo $pillar3Text;?></p>
        </div>
    </div>
</section>
<section class="pillar-section section-dark additional-content">
    <div class="main-wrapper">
        ...
        <div class="inner-wrapper">
            <h2><?php echo $pillar4Headline;?></h2>
            <p><?php echo $pillar4Text;?></p>
        </div>
    </div>
</section>